...
public class Client2 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        client.connect(new InetSocketAddress(hostname, port), null, new HandlerC2(client, configuration));

        Thread.currentThread().join();
    }
}

class HandlerC2 implements CompletionHandler<Void, Void> {
    private final AsynchronousSocketChannel client;
    private final Configuration configuration;

    public HandlerC2(AsynchronousSocketChannel client, Configuration configuration) {
        this.client = client;
        ...
        if (client.isOpen()) {
            ...
            client.read(receiveBuffer, null, new CompletionHandler<Integer, Void>() {
                ...
                public void completed(Integer bytesRead, Void attachment) {
                    ...
                    FunctionG function = new FunctionG(receivedNumber, configuration);
...
class FunctionG {
    ...
    public FunctionG(int x, Configuration configuration) {
        this.x = x;
